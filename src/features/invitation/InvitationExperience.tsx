...
import { CalendarDays, MapPin, Music2, X } from "lucide-react";
...
export default function InvitationExperience({
  ...
  return (
    <>
      <main ref={containerRef} className="min-h-screen text-ink-900">
        <section
          className={
            isOpened
              ? "pt-16 pb-12"
        ...
        <div
          ...
          data-opening
        >
          <div className="flex flex-col items-center gap-6 text-center" data-opening>
            ...
            <p className="max-w-xl text-sm leading-7 text-ink-500">
              Kami mengundangmu untuk menjadi bagian dari hari bahagia kami.
              Klik untuk membuka amplop dan temukan detail lengkap acara.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-3">
              <button
                type="button"
                onClick={handleOpen}
                className="rounded-full bg-ink-900 px-6 py-3 text-xs font-semibold uppercase tracking-[0.2em] text-white transition hover:-translate-y-0.5 hover:shadow"
              >
                {isOpened
                  ? "Undangan Terbuka"
                  : hasInteracted
            ...
            <p className="text-xs uppercase tracking-[0.3em] text-ink-400">
              {AUDIO_TRACK.title} · {AUDIO_TRACK.composer}
            </p>
            {audioError && (
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-2">
            <div className="relative">
              <button
                ...
                ref={envelopeRef}
                onClick={handleOpen}
                className="relative flex aspect-[4/3] w-full items-center justify-center rounded-3xl border border-sand-200 bg-gradient-to-br from-sand-50 via-white to-sand-100 shadow-inner"
              >
                ...
                <div className="absolute right-10 top-10 h-12 w-12 rounded-full border border-sand-300 bg-gradient-to-br from-sand-200 to-sand-100 shadow-inner" />
              ...
              >
                ...
                <p className="mt-6 text-sm leading-7 text-ink-500">
                  Kami mengundangmu untuk hadir dalam momen paling hangat dalam
                  hidup kami. Sentuhanmu di hari istimewa akan melengkapi cerita
                  cinta ini.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <p className="mt-2 text-sm text-ink-500">
                Jakarta Selatan — Satu hari penuh kebahagiaan
              </p>
            </div>
          </div>
        </div>
      ...
      {isOpened && (
        <div className="space-y-16" data-scroll-container>
            ...
            <div className="grid gap-6 md:grid-cols-[1.4fr_1fr]">
              <div>
                ...
                <p className="mt-4 text-sm leading-7 text-ink-500">
                  Dengan penuh rasa syukur, kami mengundangmu untuk merayakan hari
                  istimewa kami. Hadirnya kamu menjadi bagian dari kenangan
              ...
              <div className="grid gap-5 md:grid-cols-2">
                {Object.values(EVENT_DETAILS).map((event) => (
                  ...
                  >
                    ...
                    <p className="mt-2 text-sm text-ink-500">{event.address}</p>
                  </div>
                ))}
              </div>
              <a
          ...
          <section data-scroll-section>
            <Guestbook guestSlug={resolvedGuest.slug} guestName={resolvedGuest.name} />
          </section>
          ...
          <section className="pb-20" data-scroll-section>
            <div className="rounded-3xl border border-sand-200 bg-white/80 p-8 text-center shadow-card">
              ...
              <p className="mt-4 text-sm leading-7 text-ink-500">
                Dengan penuh cinta, kami berharap dapat merayakan momen ini bersama
                kamu. Sampai jumpa di hari bahagia kami.
              </p>
            </div>
          </section>
        </div>
